  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden film-grain">
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl">
        {/* 404 large */}
        <h1 className="font-amiri text-[160px] md:text-[220px] leading-none font-bold mb-4 text-gold-gradient">
          404
        </h1>

        {/* Arabic title */}
        <h2 className="font-amiri text-3xl md:text-5xl text-foreground mb-3">
          الصفحة غير موجودة
        </h2>
        ...
        <p className="text-muted-foreground leading-loose mb-12 max-w-lg mx-auto">
          يبدو أنك سُرت بعيدًا عن العدسة... هذه الصفحة لم تُلتقط بعد، أو ربما
          لم تكن موجودة أصلًا.
        </p>

  ...
  return (
    <section id="contact" className="py-32 md:py-48 bg-background border-t border-border">
      <div className="max-w-2xl mx-auto px-6">
        ...
        >
          <span className="font-inter text-xs tracking-[0.3em] text-muted-foreground">05</span>
          <span className="w-12 h-px bg-border" />
          <span className="eyebrow">{s.contactSubtitleEn}</span>
        </motion.div>

        {/* Header — centered, different from others */}
        <motion.div
        ...
        {/* Form — single column, underline inputs */}
        <motion.form
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-80px" }}
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-0 py-3 bg-transparent border-0 border-b border-border text-foreground placeholder:text-muted-foreground/40 focus:outline-none focus:border-primary transition-colors resize-none"
            />
          </div>
          ...
          <button
            ...
            className={`w-full py-4 font-medium transition-all duration-300 motion-ease flex items-center justify-center gap-2.5 disabled:opacity-60 ${

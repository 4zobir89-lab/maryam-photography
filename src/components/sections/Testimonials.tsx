    ...
    <section id="testimonials" className="py-32 md:py-48 bg-background">
      <div className="max-w-6xl mx-auto px-6">
        <motion.div
          ...
          className="mb-12"
        >
          <span className="eyebrow mb-3 block">Client Voices</span>
          ...
          {testimonials.map((tst, i) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 bg-card border border-border lift-card"
              >
                {/* Rating */}
                ...
                {/* Quote */}
                <p className="font-amiri text-base text-foreground leading-relaxed mb-6 line-clamp-4">
                  «{tst.quoteAr}»
                </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {tst.imageData && (
                    <BadgeCheck className="w-3.5 h-3.5 text-green-500 shrink-0 mr-auto" strokeWidth={1.5} />
                  )}
                </div>
              </motion.div>
            );
